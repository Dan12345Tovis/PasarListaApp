...
@dso_cache = dso_local local_unnamed_addr global [942 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 966745358, ; hash 0x399f5d0e, from name: aot-Lista.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1542472796, ; hash 0x5bf0445c, from name: libaot-Lista.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 322
	...
	%struct.DSOCacheEntry {
		i64 1922313503, ; hash 0x72942d1f, from name: Lista.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
	...
	%struct.DSOCacheEntry {
		i64 2101806470, ; hash 0x7d470586, from name: Lista
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 453
	...
	%struct.DSOCacheEntry {
		i64 3411108147, ; hash 0xcb516133, from name: aot-Lista
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 750
	...
	%struct.DSOCacheEntry {
		i64 4182222090, ; hash 0xf947a50a, from name: libaot-Lista
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 911
