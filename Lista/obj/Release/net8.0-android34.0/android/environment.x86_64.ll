...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555168, ; uint32_t android_runtime_jnienv_class_token (0x20002e0)
	i32 100670971, ; uint32_t jnienv_initialize_method_token (0x6001dfb)
	i32 100670970, ; uint32_t jnienv_registerjninatives_method_token (0x6001dfa)
...
@dso_cache = dso_local local_unnamed_addr global [942 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 5966705973691413083, ; hash 0x52cdff785913f25b, from name: aot-Lista.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 275
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6818465712492354294, ; hash 0x5ea00e7092499af6, from name: aot-Lista
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 313
	...
	%struct.DSOCacheEntry {
		i64 9694301946194781597, ; hash 0x86891441e851659d, from name: libaot-Lista.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
	...
	%struct.DSOCacheEntry {
		i64 10369433628436738526, ; hash 0x8fe7a0f208f631de, from name: libaot-Lista
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 519
	...
	%struct.DSOCacheEntry {
		i64 12199155741285062391, ; hash 0xa94c1b8346f696f7, from name: Lista.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 617
	...
	%struct.DSOCacheEntry {
		i64 15918168140056324500, ; hash 0xdce8b195d6ff6994, from name: Lista
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lista.dll.so
		ptr null; void* handle (0x0)
	}, ; 814
...
@.env.3 = private unnamed_addr constant [37 x i8] c"5d880531-ea4c-40b3-bf04-b752dc35589f\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.companyname.lista\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [20 x i8] c"libaot-Lista.dll.so\00", align 16
